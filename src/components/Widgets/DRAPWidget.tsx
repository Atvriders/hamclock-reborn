...
const DRAPWidget: React.FC = () => {
  ...
  const currentUrl = DRAP_URLS[urlIndex] ?? DRAP_URLS[0];
  ...
  return (
    <div style={{
      ...
      <div
        ...
        title="D-Region Absorption Prediction — click to expand"
      >
        {loading && !error && (
          <div style={{
        ...
        <img
          key={`drap-${urlIndex}-${cacheBust}`}
          src={imageUrl}
          alt="D-Region Absorption Prediction"
          onLoad={handleLoad}
          onError={handleError}
          style={{
            width: '100%',
      ...
      <div style={{ fontSize: 8, color: '#4a5568', marginTop: 3 }}>
        D-Region Absorption Prediction — NOAA/SWPC
      </div>
